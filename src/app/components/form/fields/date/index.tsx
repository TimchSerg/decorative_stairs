...
export const DateField = (props: FieldPropsType) => {
  ...
  const monthNavigatorTemplate = (e: { value: any; options: any[] | undefined; onChange: (arg0: React.SyntheticEvent<Element, Event>, arg1: any) => void; }) => {
    return <Dropdown value={e.value} options={e.options} onChange={(event) => e.onChange(event.originalEvent, event.value)} style={{ lineHeight: 1 }} />;
  }

  const yearNavigatorTemplate = (e: { value: any; options: any[] | undefined; onChange: (arg0: React.SyntheticEvent<Element, Event>, arg1: any) => void; }) => {
